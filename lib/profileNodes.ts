...
const STYLE_DEFAULT_FIELDS: WorkflowVariableField[] = [
  ...
  { id: "style-composition",      key: "composition",      value: "Single product with intentional copy space",      type: "text" },
  { id: "style-subject-anchor",   key: "subject_anchor",   value: "right_third",                                  type: "text" },
  { id: "style-subject-scale",    key: "subject_scale",    value: "medium",                                       type: "text" },
  { id: "style-copy-space-preset", key: "copy_space_preset", value: "left_two_thirds",                            type: "text" },
  { id: "style-copy-space",       key: "copy_space",       value: '{ "x": 0, "y": 0, "width": 0.6667, "height": 1 }', type: "json" },
  { id: "style-copy-space-background", key: "copy_space_background", value: "Clean, low-detail, softly lit negative space", type: "text" },
  { id: "style-copy-space-contrast", key: "copy_space_contrast", value: "high",                                  type: "text" },
  { id: "style-copy-space-avoid", key: "copy_space_avoid", value: '["objects", "shadows", "decor", "generated text"]', type: "json" },
