...
const DEMO_VIDEO_ITEMS: GalleryItem[] = [];
...
function CleanGalleryEmpty({ tab }: { tab: Tab }) {
  return (
    <div className="gallery-clean-empty" role="status">
      <div className="gallery-clean-empty-icon" aria-hidden="true">
        {tab === "videos" ? (
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="m22 8-6 4 6 4V8z" /><rect x="2" y="6" width="14" height="12" rx="2" /></svg>
        ) : (
      ...
      <h2>No {tab} yet</h2>
      <p>Use the creation controls below when you are ready to make your first {tab === "videos" ? "video" : "image"}.</p>
    </div>
  );
}
...
function GalleryInner() {
  ...
  return (
    <div style={{ flex: 1, background: "#0B0E14", display: "flex", flexDirection: "column", overflow: "hidden", color: "#fff", position: "relative" }}>
      ...
      {/* ── Grid ── */}
      {!user && process.env.NEXT_PUBLIC_GUEST_MODE !== "true" ? <CleanGalleryEmpty tab={tab} /> : <div ref={gridOuterRef} style={{ flex: 1, overflowY: "auto", paddingBottom: "260px", display: "flex", flexDirection: "column", userSelect: marqueeRect ? "none" : undefined, cursor: marqueeRect ? "crosshair" : undefined }} onMouseDown={e => {
